      ...
      <div className='div-Proyect--container'>
        ...
        <div className='div-Proyect--info'>
          ...
          <p className='p-Proyect'>
            El sitio web de Jardín Barquito de Papel está desarrollado con
            vanilla JavaScript y Sass para lograr una navegación rápida y
            funcionalidad fluida sin frameworks externos.
          </p>
          ...
          <div className='div-Proyect--buttons'>
            <a
              href='https://julian-d-rojas.github.io/Barquito_de_Papel'
              target='_blank'
            ...
            <a
              href='https://github.com/Julian-D-Rojas/Barquito_de_Papel'
              target='_blank'
              rel='noopener noreferrer'
            >
