    ...
    <>
      <div className="div-Proyect--container">
        ...
        <div className="div-Proyect--info">
          <h3 className='h3-Proyect--info'>Administración de espacios en Blanco TDT</h3>
          <p className='p-Proyect'>El sitio web de Administración de espacios en Blanco TDT está desarrollado con ReactJs y Tailwind para lograr una navegación rápida y funcionalidad fluida.</p>
          <div className="div-Proyect--technologies">
            <ReactIcon />
            <TailwindIcon />
          </div>
          <div className="div-Proyect--buttons">
            <a href="https://github.com/Julian-D-Rojas/DTTManagerFrontend">
